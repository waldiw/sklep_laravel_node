...
function hidecks() {
    ...
    setCookie("ck_5ee770b2f9ff7cda", "y", 30);
}
...
function skr_ckz() {
    let x = getCookie("ck_5ee770b2f9ff7cda");
    if (!x) {
        ...
        c.innerHTML = "<span id=\"cinfo\" style=\"flex: 1 1 auto; margin-top: 2px;\">Informacja: Serwis niniejszy wykorzystuje do prawidłowego działania pliki cookies [&nbsp;<a href=\"https://skrypt-cookies.pl/czym-sa-ciasteczka\" target=\"_blank\" style=\"text-decoration:underline;color:#fafafa;\">Więcej informacji</a>&nbsp;]</span>";
